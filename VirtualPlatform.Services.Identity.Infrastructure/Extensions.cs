...
using VirtualPlatform.Services.Identity.Application.Services.Identity;
using VirtualPlatform.Services.Identity.Core.Repositories;
using VirtualPlatform.Services.Identity.Infrastructure.Auth;
using VirtualPlatform.Services.Identity.Infrastructure.Contexts;
using VirtualPlatform.Services.Identity.Infrastructure.Decorators;
using VirtualPlatform.Services.Identity.Infrastructure.Exceptions;
using VirtualPlatform.Services.Identity.Infrastructure.Mongo;
using VirtualPlatform.Services.Identity.Infrastructure.Mongo.Documents;
using VirtualPlatform.Services.Identity.Infrastructure.Mongo.Repositories;
using VirtualPlatform.Services.Identity.Infrastructure.Services;
